...
<div class="pd-20">
    <form action="purchase/shenpi" method="post" class="form form-horizontal" id="form-purchase-add">
        <h3>采购申请详情</h3>
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>采购主题：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" id="title" name="title" value="${purchase.title}" readonly="readonly">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" id="money" name="money" value="${purchase.money}" readonly="readonly">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="${purchase.content}" readonly="readonly">
            </div>
            <div class="col-4"> </div>
        </div>
        <h3>采购审批</h3>
