...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-org-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" id="orgParentName" name="orgParentName" value="" readonly="readonly" class="input-text" datatype="*2-16" nullmsg="父组织名不能为空">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <textarea name="orgDesc" value="" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)"></textarea>
