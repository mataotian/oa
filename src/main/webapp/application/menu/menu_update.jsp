...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-menu-update">
        <input type="hidden" id="menuId" name="menuId" value="${sysMenu.menuId}"/>
        <div class="row cl">
            <label class="form-label col-3"><span class="c-red">*</span>菜单名称：</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" value="${sysMenu.menuName}" placeholder="" id="menuName" name="menuName" datatype="*2-16" nullmsg="菜单名称不能为空">
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <textarea name="menuDesc" value="" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)">
                    ${sysMenu.menuDesc}
                </textarea>
